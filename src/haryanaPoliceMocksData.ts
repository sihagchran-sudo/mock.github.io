...
export const HARYANA_POLICE_CUSTOM_MOCKS: Record<string, Question[]> = {
  "test-hssc-police-full-2": [
    ...
    {
      "id": "q-hssc-m2-28",
      "text": "Agriculture & Animal Husbandry: दुधारू पशुओं के थनों में सूजन आ जाने वाले हानिकारक रोग को क्या कहते हैं?",
      "options": [
        "खुरपका",
        "थनैला (Mastitis)",
        "गलगोटू",
  ...
  "test-hssc-police-full-5": [
    ...
    },
    {
      ...
      "correctIndex": 1,
      "explanation": "फिरोज शाह तुगलक ने 1352 ई. में फतेहाबाद और 1354 ई. में हिसार-ए-फिरोजा की स्थापना की थी।",
      "sectionName": "Haryana General Knowledge",
      "testId": "test-hssc-police-full-5"
    },
    {
    ...
    {
      "id": "q-hssc-m5-14",
      "text": "Haryana General Knowledge: हरियाणा का एकमात्र दूरदर्शन केंद्र (हिसार दूरदर्शन) किस वर्ष उद्गाठित किया गया था?",
      "options": [
        "1999",
        "2000",
        "2002",
