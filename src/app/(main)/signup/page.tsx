    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white border border-slate-200 rounded-3xl p-8 sm:p-10 shadow-lg relative">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-slate-500 mt-1">Start taking Haryana Police, SSC, & Banking mocks</p>
        </div>
        ...
        <div className="space-y-6">
          <p className="text-xs text-slate-500 text-center leading-relaxed">
            Register securely using your Google account. Google Sign-In automatically handles registration and signs you in.
          </p>
